...
// O_SYMLINK is a DARWIN flag; linux has no equivalent and node leaves it
// undefined there. It is not decoration: node gates fs.lchmod/lchmodSync on
// `constants.O_SYMLINK !== undefined`, so the constant is what decides whether
// those two exist at all.
if (process.platform === 'darwin') {
  exports.constants.O_SYMLINK = 0x200000;
}
