...
exports.chmodSync = function (p, mode) {};
exports.chmod = function (p, mode, cb) { if (cb) cb(null); };
exports.chownSync = function (p, uid, gid) {};
exports.chown = function (p, uid, gid, cb) { if (cb) cb(null); };
exports.utimesSync = function (p, a, m) {};
exports.utimes = function (p, a, m, cb) { if (cb) cb(null); };
