...
exports.lchmodSync = function (p, mode) { checkChmod(p, mode); __chmodSync(String(p), Number(mode)); };
exports.lchmod = function (p, mode, cb) { checkChmod(p, mode); _err.validateCallback(cb); __chmodSync(String(p), Number(mode)); cb(null); };
