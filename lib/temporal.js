...
def(PlainYearMonth, "from", function from(item) {
  ...
  if (m) return new PlainYearMonth(Number(m[1]), Number(m[2]));
...
function readRoundingIncrement(options) {
  if (options === undefined || options === null || typeof options !== "object") return 1;
...
function readRoundingMode(options) {
  if (options === undefined || options === null || typeof options !== "object") return "halfExpand";
