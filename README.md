...
| suite | score |
|---|---|
| [Node `test/parallel`](https://github.com/nodejs/node/tree/main/test/parallel) (all <!--fact:node-available-->3373<!--/fact--> externally runnable tests, <!--fact:node-excluded-->606<!--/fact--> node-internal excluded) | <!--fact:node-pct-->45.4%<!--/fact--> (<!--fact:node-pass-->1531<!--/fact-->/<!--fact:node-total-->3373<!--/fact-->) |
