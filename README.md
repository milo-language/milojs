...
This is an experimental implementation, not yet a drop-in replacement for QuickJS or Node. It passes <!--fact:t262-pct-->48.5%<!--/fact--> of a deterministic <!--fact:t262-sample-->1500<!--/fact-->-case test262 sample and <!--fact:qjs-pct-->67.1%<!--/fact--> of the QuickJS test suite. See [the current status](docs/status.md) for shipped capabilities, measured evidence, known gaps, and product gates.
