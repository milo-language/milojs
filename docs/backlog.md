...
- `Map.hasOwnProperty("prototype")` throws "not a function": a native
  constructor does not inherit `Object.prototype` methods through
  `Function.prototype`. Node: `true`.
