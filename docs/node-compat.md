...
last-verified: 2026-08-26 (generated from the node-compat sweep at 2b6a8ab2)
-->
...
| 🟠 | `console` | 10/21 48% | 19/25 76% | `context`, `createTask`, `dirxml`, `profile`, `profileEnd`, `timeStamp` |
...
| 🔴 | `fs` | 49/219 22% (+8 skipped) | 78/102 76% | `Dir`, `FileReadStream`, `FileWriteStream`, `ReadStream`, `Utf8Stream`, `WriteStream` +18 more |
