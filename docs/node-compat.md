...
last-verified: 2026-08-26 (generated from the node-compat sweep at e7aab7e2)
-->
...
| 🟠 | `stream` | 55/164 34% (+1 skipped) | 8/23 35% | `_isArrayBufferView`, `_isUint8Array`, `_uint8ArrayToBuffer`, `addAbortSignal`, `compose`, `destroy` +9 more |
...
| 🔴 | `http` | 85/371 23% (+6 skipped) | 12/20 60% | `CloseEvent`, `MessageEvent`, `WebSocket`, `_connectionListener`, `maxHeaderSize`, `setMaxIdleHTTPParsers` +2 more |
...
| ⚪ | `constants` | no cases | 230/230 100% | none |
