...
About <!--fact:loc-total-->41.6k<!--/fact--> lines of Milo across `src/` and `lib/`, from source text to running
...
| locked engine fixtures (`tests/*.js`) | <!--fact:fixtures-engine-->185<!--/fact--> | byte-exact differential output vs node |
