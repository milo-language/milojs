...
|---|---|---:|
| test262 (<!--fact:t262-sample-->1500<!--/fact-->-case deterministic sample, seed `<!--fact:t262-seed-->0x2f6e2b1<!--/fact-->`) | engine | **<!--fact:t262-pct-->80.7%<!--/fact-->** <!--fact:t262-pass-->1187<!--/fact-->/<!--fact:t262-scored-->1470<!--/fact--> |
...
Parse gaps: <!--fact:t262-parsefail-->22<!--/fact--> of <!--fact:t262-fail-->283<!--/fact--> test262 failures (<!--fact:t262-parsefail-pct-->7.8%<!--/fact-->) are syntax; the rest are
...
|---|---:|---:|
| `language/expressions` | 41 | 293/334 |
...
| set | count |
|---|---:|
| engine (`tests/*.js`) | <!--fact:fixtures-engine-->272<!--/fact--> |
...
<!--fact:loc-milo-->49.3k<!--/fact--> lines of Milo, <!--fact:loc-js-->18.7k<!--/fact--> of JavaScript, <!--fact:loc-total-->68.0k<!--/fact--> total. No V8,
