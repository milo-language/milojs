...
About <!--fact:loc-total-->40.3k<!--/fact--> lines of Milo across `src/` and `lib/`, from source text to running
...
| locked engine fixtures (`tests/*.js`) | <!--fact:fixtures-engine-->179<!--/fact--> | byte-exact differential output vs node |
| locked runtime fixtures (`tests/runtime/*.js`) | <!--fact:fixtures-runtime-->32<!--/fact--> | module, async, fetch, HTTP, sqlite, host behavior |
