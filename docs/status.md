...
About <!--fact:loc-total-->42.2k<!--/fact--> lines of Milo across `src/` and `lib/`, from source text to running
...
| locked engine fixtures (`tests/*.js`) | <!--fact:fixtures-engine-->190<!--/fact--> | byte-exact differential output vs node |
