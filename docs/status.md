...
| set | count |
|---|---:|
| engine (`tests/*.js`) | <!--fact:fixtures-engine-->285<!--/fact--> |
...
<!--fact:loc-milo-->50.5k<!--/fact--> lines of Milo, <!--fact:loc-js-->19.0k<!--/fact--> of JavaScript, <!--fact:loc-total-->69.5k<!--/fact--> total. No V8,
