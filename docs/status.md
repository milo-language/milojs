...
About <!--fact:loc-total-->60.4k<!--/fact--> lines of Milo across `src/` and `lib/`, from source text to running
...
| locked engine fixtures (`tests/*.js`) | <!--fact:fixtures-engine-->252<!--/fact--> | byte-exact differential output vs node |
