...
About <!--fact:loc-total-->59.1k<!--/fact--> lines of Milo across `src/` and `lib/`, from source text to running
...
| locked engine fixtures (`tests/*.js`) | <!--fact:fixtures-engine-->232<!--/fact--> | byte-exact differential output vs node |
