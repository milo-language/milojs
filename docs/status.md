...
About <!--fact:loc-total-->44.1k<!--/fact--> lines of Milo across `src/` and `lib/`, from source text to running
...
|---|---:|---|
| deterministic test262 sample (<!--fact:t262-sample-->1500<!--/fact--> selected, <!--fact:t262-skipped-->30<!--/fact--> skipped) | **<!--fact:t262-pass-->856<!--/fact-->/<!--fact:t262-scored-->1470<!--/fact--> = <!--fact:t262-pct-->58.2%<!--/fact-->** | test262 `<!--fact:t262-corpus-->b363f29d<!--/fact-->`, seed `<!--fact:t262-seed-->0x2f6e2b1<!--/fact-->` |
...
| locked engine fixtures (`tests/*.js`) | <!--fact:fixtures-engine-->203<!--/fact--> | byte-exact differential output vs node |
...
**test262 moved 34.6% to <!--fact:t262-pct-->58.2%<!--/fact--> over 2026-08-15**, from one structural finding
...
<!--fact:t262-pct-->58.2%<!--/fact--> figure: the exclusion is context, not a headline.
