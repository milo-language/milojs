...
About <!--fact:loc-total-->61.1k<!--/fact--> lines of Milo across `src/` and `lib/`, from source text to running
...
| locked engine fixtures (`tests/*.js`) | <!--fact:fixtures-engine-->259<!--/fact--> | byte-exact differential output vs node |
