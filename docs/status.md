...
| set | count |
|---|---:|
| engine (`tests/*.js`) | <!--fact:fixtures-engine-->266<!--/fact--> |
| runtime (`tests/runtime/*.js`) | <!--fact:fixtures-runtime-->56<!--/fact--> |
...
<!--fact:loc-milo-->47.9k<!--/fact--> lines of Milo, <!--fact:loc-js-->16.6k<!--/fact--> of JavaScript, <!--fact:loc-total-->64.4k<!--/fact--> total. No V8,
