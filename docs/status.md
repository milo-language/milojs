...
last-verified: 2026-08-16 (sweep republished after unicode identifiers; scores are compiled facts, not prose)
-->
...
|---|---:|---|
| deterministic test262 sample (<!--fact:t262-sample-->1500<!--/fact--> selected, <!--fact:t262-skipped-->30<!--/fact--> skipped) | **<!--fact:t262-pass-->735<!--/fact-->/<!--fact:t262-scored-->1470<!--/fact--> = <!--fact:t262-pct-->50.0%<!--/fact-->** | test262 `<!--fact:t262-corpus-->b363f29d<!--/fact-->`, seed `<!--fact:t262-seed-->0x2f6e2b1<!--/fact-->` |
...
**test262 moved 34.6% to <!--fact:t262-pct-->50.0%<!--/fact--> over 2026-08-15**, from one structural finding
...
<!--fact:t262-pct-->50.0%<!--/fact--> figure: the exclusion is context, not a headline.
