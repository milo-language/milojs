...
last-verified: 2026-08-16 (sweep republished after strict mode; scores are compiled facts, not prose) (both sweeps re-run against 573b2fb; the built-in prototype sweep and generator completions landed; Gate 0 is RED on linux-arm64)
-->
...
About <!--fact:loc-total-->42.4k<!--/fact--> lines of Milo across `src/` and `lib/`, from source text to running
...
|---|---:|---|
| deterministic test262 sample (<!--fact:t262-sample-->1500<!--/fact--> selected, <!--fact:t262-skipped-->30<!--/fact--> skipped) | **<!--fact:t262-pass-->713<!--/fact-->/<!--fact:t262-scored-->1470<!--/fact--> = <!--fact:t262-pct-->48.5%<!--/fact-->** | test262 `<!--fact:t262-corpus-->b363f29d<!--/fact-->`, seed `<!--fact:t262-seed-->0x2f6e2b1<!--/fact-->` |
| QuickJS `tests/` | **<!--fact:qjs-pass-->100<!--/fact-->/<!--fact:qjs-total-->149<!--/fact--> = <!--fact:qjs-pct-->67.1%<!--/fact-->** | quickjs `<!--fact:qjs-corpus-->ef7a3a74<!--/fact-->`, 58 files |
| locked engine fixtures (`tests/*.js`) | <!--fact:fixtures-engine-->192<!--/fact--> | byte-exact differential output vs node |
...
**test262 moved 34.6% to <!--fact:t262-pct-->48.5%<!--/fact--> over 2026-08-15**, from one structural finding
...
<!--fact:t262-pct-->48.5%<!--/fact--> figure: the exclusion is context, not a headline.
