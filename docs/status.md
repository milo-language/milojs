...
About <!--fact:loc-total-->58.4k<!--/fact--> lines of Milo across `src/` and `lib/`, from source text to running
...
| locked engine fixtures (`tests/*.js`) | <!--fact:fixtures-engine-->228<!--/fact--> | byte-exact differential output vs node |
