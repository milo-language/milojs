...
| runtime (`tests/runtime/*.js`) | <!--fact:fixtures-runtime-->55<!--/fact--> |
...
<!--fact:loc-milo-->47.9k<!--/fact--> lines of Milo, <!--fact:loc-js-->16.5k<!--/fact--> of JavaScript, <!--fact:loc-total-->64.4k<!--/fact--> total. No V8,
