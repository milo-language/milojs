...
| Node `test/parallel` | runtime | **<!--fact:node-pct-all-->16.9%<!--/fact-->** <!--fact:node-pass-->571<!--/fact-->/<!--fact:node-total-->3373<!--/fact--> |
...
runtime got strictly better. Against what ran it is <!--fact:node-pct-->23.4%<!--/fact-->
(<!--fact:node-pass-->571<!--/fact-->/<!--fact:node-ran-->2437<!--/fact-->); that form is for tracking milojs against itself,
...
| runtime (`tests/runtime/*.js`) | <!--fact:fixtures-runtime-->61<!--/fact--> |
...
<!--fact:loc-milo-->48.0k<!--/fact--> lines of Milo, <!--fact:loc-js-->17.1k<!--/fact--> of JavaScript, <!--fact:loc-total-->65.1k<!--/fact--> total. No V8,
