...
| runtime (`tests/runtime/*.js`) | <!--fact:fixtures-runtime-->50<!--/fact--> |
...
<!--fact:loc-milo-->47.6k<!--/fact--> lines of Milo, <!--fact:loc-js-->16.2k<!--/fact--> of JavaScript, <!--fact:loc-total-->63.8k<!--/fact--> total. No V8,
