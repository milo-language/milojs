...
About <!--fact:loc-total-->40.8k<!--/fact--> lines of Milo across `src/` and `lib/`, from source text to running
...
| locked runtime fixtures (`tests/runtime/*.js`) | <!--fact:fixtures-runtime-->33<!--/fact--> | module, async, fetch, HTTP, sqlite, host behavior |
