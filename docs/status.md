...
| runtime (`tests/runtime/*.js`) | <!--fact:fixtures-runtime-->48<!--/fact--> |
...
<!--fact:loc-milo-->47.6k<!--/fact--> lines of Milo, <!--fact:loc-js-->15.8k<!--/fact--> of JavaScript, <!--fact:loc-total-->63.4k<!--/fact--> total. No V8,
