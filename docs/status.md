...
| runtime (`tests/runtime/*.js`) | <!--fact:fixtures-runtime-->53<!--/fact--> |
...
<!--fact:loc-milo-->47.8k<!--/fact--> lines of Milo, <!--fact:loc-js-->16.4k<!--/fact--> of JavaScript, <!--fact:loc-total-->64.1k<!--/fact--> total. No V8,
