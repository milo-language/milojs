...
About <!--fact:loc-total-->48.4k<!--/fact--> lines of Milo across `src/` and `lib/`, from source text to running
...
| locked engine fixtures (`tests/*.js`) | <!--fact:fixtures-engine-->216<!--/fact--> | byte-exact differential output vs node |
