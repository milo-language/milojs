...
About <!--fact:loc-total-->44.4k<!--/fact--> lines of Milo across `src/` and `lib/`, from source text to running
...
| locked engine fixtures (`tests/*.js`) | <!--fact:fixtures-engine-->210<!--/fact--> | byte-exact differential output vs node |
