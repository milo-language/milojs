...
| set | count |
|---|---:|
| engine (`tests/*.js`) | <!--fact:fixtures-engine-->267<!--/fact--> |
| runtime (`tests/runtime/*.js`) | <!--fact:fixtures-runtime-->58<!--/fact--> |
...
<!--fact:loc-milo-->47.9k<!--/fact--> lines of Milo, <!--fact:loc-js-->17.0k<!--/fact--> of JavaScript, <!--fact:loc-total-->64.9k<!--/fact--> total. No V8,
