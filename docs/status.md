...
About <!--fact:loc-total-->61.0k<!--/fact--> lines of Milo across `src/` and `lib/`, from source text to running
...
| locked engine fixtures (`tests/*.js`) | <!--fact:fixtures-engine-->257<!--/fact--> | byte-exact differential output vs node |
| locked runtime fixtures (`tests/runtime/*.js`) | <!--fact:fixtures-runtime-->36<!--/fact--> | module, async, fetch, HTTP, sqlite, host behavior |
