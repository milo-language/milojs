...
| set | count |
|---|---:|
| engine (`tests/*.js`) | <!--fact:fixtures-engine-->289<!--/fact--> |
...
<!--fact:loc-milo-->51.3k<!--/fact--> lines of Milo, <!--fact:loc-js-->19.1k<!--/fact--> of JavaScript, <!--fact:loc-total-->70.3k<!--/fact--> total. No V8,
