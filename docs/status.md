...
| set | count |
|---|---:|
| engine (`tests/*.js`) | <!--fact:fixtures-engine-->279<!--/fact--> |
...
<!--fact:loc-milo-->49.9k<!--/fact--> lines of Milo, <!--fact:loc-js-->18.8k<!--/fact--> of JavaScript, <!--fact:loc-total-->68.6k<!--/fact--> total. No V8,
