...
| runtime (`tests/runtime/*.js`) | <!--fact:fixtures-runtime-->52<!--/fact--> |
...
<!--fact:loc-milo-->47.7k<!--/fact--> lines of Milo, <!--fact:loc-js-->16.3k<!--/fact--> of JavaScript, <!--fact:loc-total-->64.0k<!--/fact--> total. No V8,
