...
|---|---|---:|
| test262 (<!--fact:t262-sample-->1500<!--/fact-->-case deterministic sample, seed `<!--fact:t262-seed-->0x2f6e2b1<!--/fact-->`) | engine | **<!--fact:t262-pct-->80.5%<!--/fact-->** <!--fact:t262-pass-->1184<!--/fact-->/<!--fact:t262-scored-->1470<!--/fact--> |
...
Parse gaps: <!--fact:t262-parsefail-->23<!--/fact--> of <!--fact:t262-fail-->286<!--/fact--> test262 failures (<!--fact:t262-parsefail-pct-->8.0%<!--/fact-->) are syntax; the rest are
...
<!--fact:loc-milo-->49.5k<!--/fact--> lines of Milo, <!--fact:loc-js-->18.7k<!--/fact--> of JavaScript, <!--fact:loc-total-->68.3k<!--/fact--> total. No V8,
