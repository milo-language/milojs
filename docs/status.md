...
| runtime (`tests/runtime/*.js`) | <!--fact:fixtures-runtime-->42<!--/fact--> |
...
<!--fact:loc-milo-->47.6k<!--/fact--> lines of Milo, <!--fact:loc-js-->15.1k<!--/fact--> of JavaScript, <!--fact:loc-total-->62.8k<!--/fact--> total. No V8,
