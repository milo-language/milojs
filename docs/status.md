...
About <!--fact:loc-total-->59.9k<!--/fact--> lines of Milo across `src/` and `lib/`, from source text to running
...
| locked engine fixtures (`tests/*.js`) | <!--fact:fixtures-engine-->249<!--/fact--> | byte-exact differential output vs node |
