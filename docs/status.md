...
| set | count |
|---|---:|
| engine (`tests/*.js`) | <!--fact:fixtures-engine-->290<!--/fact--> |
...
<!--fact:loc-milo-->51.5k<!--/fact--> lines of Milo, <!--fact:loc-js-->19.1k<!--/fact--> of JavaScript, <!--fact:loc-total-->70.6k<!--/fact--> total. No V8,
