...
About <!--fact:loc-total-->39.2k<!--/fact--> lines of Milo across `src/` and `lib/`, from source text to running
...
| locked runtime fixtures (`tests/runtime/*.js`) | <!--fact:fixtures-runtime-->30<!--/fact--> | module, async, fetch, HTTP, sqlite, host behavior |
