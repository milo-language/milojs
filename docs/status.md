...
| set | count |
|---|---:|
| engine (`tests/*.js`) | <!--fact:fixtures-engine-->273<!--/fact--> |
...
<!--fact:loc-milo-->49.3k<!--/fact--> lines of Milo, <!--fact:loc-js-->18.8k<!--/fact--> of JavaScript, <!--fact:loc-total-->68.1k<!--/fact--> total. No V8,
