...
| set | count |
|---|---:|
| engine (`tests/*.js`) | <!--fact:fixtures-engine-->265<!--/fact--> |
| runtime (`tests/runtime/*.js`) | <!--fact:fixtures-runtime-->54<!--/fact--> |
...
<!--fact:loc-milo-->47.8k<!--/fact--> lines of Milo, <!--fact:loc-js-->16.4k<!--/fact--> of JavaScript, <!--fact:loc-total-->64.2k<!--/fact--> total. No V8,
