...
| runtime (`tests/runtime/*.js`) | <!--fact:fixtures-runtime-->45<!--/fact--> |
...
<!--fact:loc-milo-->47.6k<!--/fact--> lines of Milo, <!--fact:loc-js-->15.3k<!--/fact--> of JavaScript, <!--fact:loc-total-->63.0k<!--/fact--> total. No V8,
