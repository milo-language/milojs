...
| set | count |
|---|---:|
| engine (`tests/*.js`) | <!--fact:fixtures-engine-->286<!--/fact--> |
...
<!--fact:loc-milo-->50.7k<!--/fact--> lines of Milo, <!--fact:loc-js-->19.0k<!--/fact--> of JavaScript, <!--fact:loc-total-->69.7k<!--/fact--> total. No V8,
