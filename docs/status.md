...
| set | count |
|---|---:|
| engine (`tests/*.js`) | <!--fact:fixtures-engine-->274<!--/fact--> |
...
<!--fact:loc-milo-->49.4k<!--/fact--> lines of Milo, <!--fact:loc-js-->18.8k<!--/fact--> of JavaScript, <!--fact:loc-total-->68.2k<!--/fact--> total. No V8,
