...
| runtime (`tests/runtime/*.js`) | <!--fact:fixtures-runtime-->57<!--/fact--> |
...
<!--fact:loc-milo-->47.9k<!--/fact--> lines of Milo, <!--fact:loc-js-->16.8k<!--/fact--> of JavaScript, <!--fact:loc-total-->64.6k<!--/fact--> total. No V8,
